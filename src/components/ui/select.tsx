...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-10 w-full items-center justify-between rounded-md border border-purple-200 bg-white px-3 py-2 text-sm ring-offset-white placeholder:text-purple-500 focus:outline-none focus:ring-2 focus:ring-purple-950 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1 dark:border-purple-800 dark:bg-purple-950 dark:ring-offset-purple-950 dark:placeholder:text-purple-400 dark:focus:ring-purple-300",
      className,
    )}
    {...props}
  >
